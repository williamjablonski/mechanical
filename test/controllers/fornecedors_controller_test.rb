...
class FornecedorsControllerTest < ActionController::TestCase
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post :create, fornecedor: { contato: @fornecedor.contato, empresa: @fornecedor.empresa, observacoes: @fornecedor.observacoes, telefone: @fornecedor.telefone }
    end
  ...
  test "should update fornecedor" do
    patch :update, id: @fornecedor, fornecedor: { contato: @fornecedor.contato, empresa: @fornecedor.empresa, observacoes: @fornecedor.observacoes, telefone: @fornecedor.telefone }
    assert_redirected_to fornecedor_path(assigns(:fornecedor))
  end
