...
class VeiculosControllerTest < ActionController::TestCase
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post :create, veiculo: { ano: @veiculo.ano, contato: @veiculo.contato, modelo: @veiculo.modelo, placa: @veiculo.placa, telefone: @veiculo.telefone }
    end
  ...
  test "should update veiculo" do
    patch :update, id: @veiculo, veiculo: { ano: @veiculo.ano, contato: @veiculo.contato, modelo: @veiculo.modelo, placa: @veiculo.placa, telefone: @veiculo.telefone }
    assert_redirected_to veiculo_path(assigns(:veiculo))
  end
